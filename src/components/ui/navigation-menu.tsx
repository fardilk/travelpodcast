...
>(({ className, style, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      "data-[state=closed]:hidden data-[state=open]:block left-0 top-0 w-full data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out md:fixed md:left-0 md:top-0 md:w-full md:h-[80vh] md:rounded-none md:shadow-lg md:overflow-auto md:nav-bg-green",
      className
    )}
